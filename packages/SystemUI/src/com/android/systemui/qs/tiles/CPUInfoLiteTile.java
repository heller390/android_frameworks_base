...
public class CPUInfoLiteTile extends QSTileImpl<BooleanState> {

    public static final String TILE_SPEC = "cpuinfolite";
    ...
    protected void toggleState() {
        Intent service = (new Intent())
                ...
                "com.android.systemui.CPUInfoServiceLite");
    ...
    protected void handleUpdateState(BooleanState state, Object arg) {
        ...
        state.label = mContext.getString(R.string.quick_settings_cpuinfolite_label);
        state.icon = mIcon;
        state.contentDescription =  mContext.getString(
                R.string.quick_settings_cpuinfolite_label);
        if (cpuInfoEnabled) {
    ...
    public CharSequence getTileLabel() {
        return mContext.getString(R.string.quick_settings_cpuinfolite_label);
    }
