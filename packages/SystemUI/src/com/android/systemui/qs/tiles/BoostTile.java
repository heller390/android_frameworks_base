...
public class BoostTile extends QSTileImpl<BooleanState> {
    ...
    private final Icon mIcon = ResourceIcon.get(R.drawable.ic_qs_boost);
    ...
    public CharSequence getTileLabel() {
        return "Boost"; //mContext.getString(R.string.quick_settings_stamina_label);
    }
    ...
    protected void handleUpdateState(BooleanState state, Object arg) {
        ...
        state.icon = mIcon;
        if( mBoostEnabled )
            state.label = "Boost Enabled";  //mContext.getString(R.string.quick_settings_stamina_label);
        else
            state.label = "Boost Disabled";  //mContext.getString(R.string.quick_settings_stamina_label);
